...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Filtros - Reporte de Reservas.</h4>
        </div>
            ...
            <table class="table table-condensed table-bordered">
                ...
                @foreach($detallesReserva as $detalle)
                    <tr>
                        ...
                        <td>{{ $detalle->reserva->user->nombres }} {{ $detalle->reserva->user->apellidos }}</td>
                        <td>{{ $detalle->reserva->user->documento }}</td>
                        <td>{{ $detalle->reserva->created_at->format('d/m/Y h:i A') }}</td>
                        <td>{{ $detalle->reserva->fechaInicio->format('d/m/Y h:i A') }}</td>
                        <td>{{ $detalle->reserva->fechaFin->format('d/m/Y h:i A') }}</td>
