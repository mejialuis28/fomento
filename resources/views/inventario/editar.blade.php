...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Editar item de inventario</h4>
        </div>
                ...
                <fieldset>
                    <div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="txtPlaca" name="placa" value="{{$inventario->placa}}" required class="form-control" type="number" placeholder=" Número de placa"/>
                            </div>
                            <label for="txtDescripcion" class="col-md-2 control-label">Descripción</label>
                            <div class="col-md-4">
                                <textarea id="txtDescripcion" name="descripcion" required class="form-control" placeholder=" Ingrese una descripción">{{$inventario->descripcion}}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="categoria" id="txtCategoria" required>
                                    @foreach($categorias as $cat)
                                        @if($cat->id == $inventario->categoria)
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input id="txtValor" required name="valor" value="{{$inventario->valor}}" class="form-control" type="number" placeholder=" Valor del Item"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="txtMarca" name="marca" value="{{$inventario->marca}}" required class="form-control" type="text" placeholder=" Marca" />
                            </div>
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="estadoArticulo" id="txtEstado" required>
                                    @foreach($estados as $est)
                                        @if($est->id == $inventario->estadoArticulo)
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="responsable" id="txtResponsable" required>
                                    @foreach($responsables as $resp)
                                        @if($resp->user->id == $inventario->responsable)
                                            <option value="{{ $resp->user->id }}" selected>{{ $resp->user->nombres }} {{ $resp->user->apellidos }}</option>
                                        @else
                            ...
                            <div class="col-md-4">
                                <input id="txtFechaIngreso" name="fechaIngreso" data-date-format="dd/mm/yyyy" value="{{$inventario->fechaIngreso}}" class="form-control" required type="text" placeholder=" dd/mm/aaaa"/>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-md-offset-2">
                                <label>
                                    <input type="checkbox" checked="{{$inventario->habilitadoPrestamo}}" name="habilitadoPrestamo" class="checkbox-inline" id="chkPrestamo"/> Habilitar para préstamo?
                                </label>
                            </div>
                        </div>
                    </div>
