                                ...
                                <table style="border-collapse:collapse;border-spacing:0;table-layout:fixed;width:100%">
                                    <tbody><tr>
                                        <td style="padding:0;vertical-align:top;padding-left:32px;padding-right:32px;word-break:break-word;word-wrap:break-word">
                                            <h2 style="Margin-top:0;color:#29853f;font-style:italic;font-weight:normal;font-size:26px;line-height:34px;Margin-bottom:20px;font-family:sans-serif"><strong style="font-weight:bold">Reservas del día.</strong></h2>
                                            ...
                                            <h3 style="Margin-top:0;color:#555;font-weight:normal;font-size:18px;line-height:26px;Margin-bottom:16px;font-family:Georgia,serif">A continuación se relaciona el listado de reservas del laboratorio de fomento cultural para el día de hoy: </h3>
