                                ...
                                <table style="border-collapse:collapse;border-spacing:0;table-layout:fixed;width:100%">
                                    <tbody><tr>
                                        <td style="padding:0;vertical-align:top;padding-left:32px;padding-right:32px;word-break:break-word;word-wrap:break-word">
                                            <h2 style="Margin-top:0;color:#29853f;font-style:italic;font-weight:normal;font-size:26px;line-height:34px;Margin-bottom:20px;font-family:sans-serif"><strong style="font-weight:bold">Rechazo de reserva</strong></h2>
                                            <h3 style="Margin-top:0;color:#555;font-weight:normal;font-size:18px;line-height:26px;Margin-bottom:16px;font-family:Georgia,serif">
                                                Cordial Saludo. <strong>{{ $nombre }}</strong></h3>
                                            <h3 style="Margin-top:0;color:#555;font-weight:normal;font-size:18px;line-height:26px;Margin-bottom:16px;font-family:Georgia,serif">Le notificamos que la reserva número <strong>{{ $numero }}</strong> que realizó a través del aplicativo de reservas de la dirección de fomento cultural del Politecnico Colombiano Jaime Isaza cadavid ha sido rechazada por los siguientes motivos:</h3><p style="Margin-top:0;color:#565656;font-family:Georgia,serif;font-size:16px;line-height:25px;Margin-bottom:25px"><em> {{ $motivo }} </em></p><p style="Margin-top:0;color:#565656;font-family:Georgia,serif;font-size:16px;line-height:25px;Margin-bottom:24px">Agradecemos su comprensión al respecto.</p>
