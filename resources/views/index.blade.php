...
@section('content')
    <div>
        <div class="container">
            ...
            <h3 class="text-center">Laboratorio de Fomento Cultural Politecnico Colombiano Jaime Isaza Cadavid.</h3>
            </br>
            <p class="lead">
                El de inventario, reserva y préstamo de instrumentos permite al laboratorio de Fomento Cultural del Politécnico Colombiano Jaime Isaza Cadavid proveer a la comunidad Politécnica una opción simple para reservar instrumentos que el laboratorio ha puesto a su disposición.
            </p>
            @if(Auth::guest())
